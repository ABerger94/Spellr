...
- Your hand wraps into rows and shrinks cards to fit as needed so up to 20 cards are visible at once with no scrolling (beyond that it scrolls vertically instead of shrinking further); drag the handle above the hand bar to resize it bigger or smaller
