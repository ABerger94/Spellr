...
- A live "N players online" count on the Lobby page, backed by a single site-wide presence channel subscribed once at the app root (not per-page), so it doesn't flicker as you navigate and every page shares one connection
